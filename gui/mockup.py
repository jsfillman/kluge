...
class KlugeJobPopup(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("kluge-logo.png"))
        self.setWindowTitle("Kluge Job Status")
        self.setGeometry(50, 50, 100, 200)  # Default compact size
    ...
    def toggle_details(self):
        ...
        if self.details_frame.isVisible():
            ...
            self.resize(self.default_width, self.default_height)  # Shrink back properly
        else:
            self.details_frame.setVisible(True)
            self.details_button.setText("Hide Details")
            self.resize(self.default_width, self.expanded_height)  # Expand smoothly
